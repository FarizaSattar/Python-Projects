...
''' The code uses Selenium to automate job applications on LinkedIn, logging in, navigating to job listings, 
solving CAPTCHA manually, and applying for jobs, handling different scenarios like missing application buttons
or complex applications, before quitting the browser. '''
...
# Replace with your login email, password, and phone number
ACCOUNT_EMAIL = "YOUR LOGIN EMAIL"
ACCOUNT_PASSWORD = "YOUR LOGIN PASSWORD"
PHONE = "YOUR PHONE NUMBER"

# Function to handle application abort
