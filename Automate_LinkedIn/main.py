# Automate LinkedIn
''' The code allows the user to automate job applications on LinkedIn, logging in, navigating to job listings, 
solving CAPTCHA manually, and applying for jobs. '''
''' 
...
# This function will handle application abort
...
# Keep your chromedriver up to date.
...
for listing in all_listings:
  ...
  try:
    ...
    # Insert Phone Number - Find an <input> element where the id contains phoneNumber
    time.sleep(5)
